...
public class ItemServiceImplServiceLocator extends org.apache.axis.client.Service implements com.candybar.service.ItemServiceImplService {
    ...
    private java.lang.String ItemServiceImpl_address = "http://localhost:8080/CandyBar/services/ItemServiceImpl";
    ...
    public com.candybar.service.ItemServiceImpl getItemServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.candybar.service.ItemServiceImpl getItemServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.candybar.service.ItemServiceImplSoapBindingStub _stub = new com.candybar.service.ItemServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.candybar.service.ItemServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.candybar.service.ItemServiceImplSoapBindingStub _stub = new com.candybar.service.ItemServiceImplSoapBindingStub(new java.net.URL(ItemServiceImpl_address), this);
                _stub.setPortName(getItemServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.candybar.com", "ItemServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.candybar.com", "ItemServiceImpl"));
        }
